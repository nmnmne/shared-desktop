      ...
      <div class="form-inline">
        ...
        <div class="preset-group">
          ...
          <div v-show="showSelect">
            <!-- Выбор пресета -->
            <div>
              <select class="preset minitext_" style="padding: 2px 10px 1px 2px" v-model="selectedPresetId" @change="loadPreset">
              ...
              <!-- Сохранение пресета -->
              <input class="preset minitext_" v-model="presetName" placeholder="Название сохроняемого" />
