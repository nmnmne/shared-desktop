...
from tools.toolkit.sdp_lib.potok_controller.generate_condition.constants import (
    Patterns,
    MATCHING_OPERATORS,
    FieldNames,
    ErrMessages
)
from tools.toolkit.sdp_lib.potok_controller.generate_condition.tokens import Token
from tools.toolkit.sdp_lib.potok_controller.generate_condition.utils import get_main_and_mr_stmt
